<script lang="ts">
	...
	const roleImages: Record<Role, string> = {
		loyalist: '/images/characters/the-loyalist.webp',
		spy: '/images/characters/the-spy.webp',
		assassin: '/images/characters/the-assassin.webp',
		merlin: '/images/characters/the-mole.webp'
	};
